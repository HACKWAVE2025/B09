...
const ActivitiesPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Update state so calendar and profile refresh immediately
            window.dispatchEvent(new Event("storage")); // optional if other components listen
            // Or you can force refresh of state
            // setUser(updatedUser);
