...
import { FaLeaf, FaMapMarkerAlt, FaClock } from "react-icons/fa";
...
const ActivitiesPage = () => {
  ...
  // ✅ Generate image preview + capture upload timestamp
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            {previewURL && (
              <div className="mt-3 preview-section">
                <img
                  src={previewURL}
                  alt="Preview"
                  className="preview-image"
                />
                <div className="geo-info text-muted small mt-2">
                  <p>
