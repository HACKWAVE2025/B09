...
//                 <div className="my-4">
//                     <button className="btn btn-warning px-4" onClick={handleSummarizeToday} disabled={loadingSummary}>
...
//                             <div
//                                 ref={summaryRef}
//                                 className={`mt-3 p-3 rounded shadow ${theme === "dark" ? "bg-dark text-light" : "bg-light text-dark"
//                                     }`}
...
// import "react-calendar/dist/Calendar.css";
// import html2canvas from "html2canvas";
// import { QRCodeCanvas } from "qrcode.react"; // ✅ correct QR import
...
//                 <div
//                   key={i}
//                   className={`badge-card p-3 rounded shadow ${
//                     theme === "dark" ? "bg-success text-light" : "bg-primary text-light"
//                   }`}
//                   style={{ width: "130px" }}
//                 >
//                   <div className="fs-2 mb-1">{badge.icon || "🏅"}</div>
...
//         {selectedDate && (
//           <div
//             className={`activities-list mx-auto p-4 rounded shadow ${
//               theme === "dark" ? "bg-secondary text-light" : "bg-white text-dark"
//             }`}
//             style={{ maxWidth: "600px" }}
//           >
...
//                       theme === "dark" ? "bg-dark text-light border-light" : "bg-light text-dark"
//                     }`}
//                   >
//                     <strong>{act.activityType}</strong> — {act.pointsEarned} pts, CO₂ saved: {act.co2Saved} kg
//                   </li>
...
//           <h4 className="fw-bold">Your Unique Profile QR</h4>
//           <p className="text-muted">Scan to view your eco-profile details</p>
//           <QRCodeCanvas
